...
This project maintains lists of words that are, by their nature, offensive, political or
otherwise sensitive. Discussing those terms as data — whether a term belongs in a category,
whether a severity is right, whether a match is a false positive — is on-topic and welcome.

Using an issue, a pull request or a commit message as a vehicle for the content of those
terms is not. Keep the discussion about classification and detection, not about the subject
matter of the words. Political advocacy in either direction about what belongs in a
censorship word list is off-topic here; the upstream project is the place for the composition
...
[private security advisory](https://github.com/open-moderation-lexicon/open-moderation-lexicon/security/advisories/new)
or by email to the maintainers listed in `package.json`. All complaints will be reviewed and
